public class CommonExceptionsDemo {
    public static void main(String[] args) {
        ...
        } catch (ArithmeticException ex) { // TODO: catch ArithmeticException
        ...
        } catch (NullPointerException ex) { // TODO: catch NullPointerException
            // TODO: print "Caught: " + ex.getClass().getSimpleName()
            System.out.println("Caught: " + ex.getClass().getSimpleName());
        }
        ...
        } catch (ArrayIndexOutOfBoundsException ex) { // TODO: catch ArrayIndexOutOfBoundsException
            // TODO: print "Caught: " + ex.getClass().getSimpleName()
            System.out.println("Caught: " + ex.getClass().getSimpleName());
        }
